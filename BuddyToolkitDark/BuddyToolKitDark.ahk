...
BuddyGui.Add("Text", "xm cfdfdfd", "Toolkit Version 1"), 
TemplateTab := BuddyGui.Add("Tab3","xm h100 w700 Background2a3441 cFFFFFF", ["Accounts", "Faults","Delivery","Complaints",])
ToolsTab := BuddyGui.Add("Tab3", "WP h760 Background2a3441 cFFFFFF", ["Notepad", "QOL", "Automations", "About"])
...
ToolsTab.UseTab(1)
Notes := BuddyGui.Add("Edit", "h705 w670 Background252525 cFFFFFF", "")
