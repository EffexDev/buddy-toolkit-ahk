...
DeliveryReasons := ["Activations", "Validation", "Banlisting", "Missing Payment Info"]
DeliveryTemplates := [["Day 1","Day 2", "HFC Details"],["Day 1","Day 2", "Day 3"],["Day 1"],["Day 1","Day 2", "Day 3"]]
ActivationsMap := Map(
